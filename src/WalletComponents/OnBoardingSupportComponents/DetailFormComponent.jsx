                    ...
                    <MuiThemeProvider theme={InputThemes.SingleInputTheme}>
                        <div style={{ display: 'inline-block' }}>
                            <TextField label={this.props.field} type={this.props.type}
                                error={this.props.field === localeObj.email || utilities.validateParameters(this.props.field, this.state.field) ? false : true}
                                ...
                                placeholder={this.props.field === localeObj.add_comp ? localeObj.pix_optional : ""}
                                helperText={this.props.field === localeObj.email || utilities.validateParameters(this.props.field, this.state.field) ? "" :
                                    (this.props.field === localeObj.cnpj ? localeObj.cnpj_error : GeneralUtilities.formattedString(localeObj.invalid, [this.props.field]))}
                            />
