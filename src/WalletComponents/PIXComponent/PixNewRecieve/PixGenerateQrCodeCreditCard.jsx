...
class PixGenerateQrCodeCreditCard extends React.Component {
    constructor(props) {
        super(props);
        this.styles = {
            qrContainer: {
    ...
    copyCode = () => {
        androidApiCalls.copyToClipBoard(this.props.copyCode);
        this.setState({
    ...
    render() {
        ...
        return (
            <div className="scroll" style={{ display: !this.state.processing ? "block" : "none", height: `${screenHeight - 295}px`, overflowY: "auto", overflowX: "hidden" }}>
                ...
                {/*<div align="center" style={{ width: "100%", margin: "1.5rem 0" }} data-html2canvas-ignore="true">
                ...
                {!this.state.processing &&
                    <div style={{...InputThemes.bottomButtonStyle, textAlign: "center"}} data-html2canvas-ignore="true">
                        ...
                        <TimeOutSecondaryButton btn_text={localeObj.credit_pix_btn} onCheck={this.props.onContinue} />
                    </div>
                }
...
PixGenerateQrCodeCreditCard.propTypes = {
...
export default withStyles(styles)(PixGenerateQrCodeCreditCard);